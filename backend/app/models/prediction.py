...
class Prediction(Base):
    ...
    probability_1: Mapped[float | None] = mapped_column(
        Float,
        nullable=True,
    )
    probability_2: Mapped[float | None] = mapped_column(
        Float,
        nullable=True,
    )
    probability_3: Mapped[float | None] = mapped_column(
        Float,
        nullable=True,
    )
    probability_4: Mapped[float | None] = mapped_column(
        Float,
        nullable=True,
    )
